...
type KillerDaggerState = state.KillerDaggerState
type KillerAirborneDaggerState = state.KillerAirborneDaggerState
...
type MonkESlowState = state.MonkESlowState
...
const (
	...
	EntityKindFruit        = model.EntityKindFruit
	EntityKindWard         = model.EntityKindWard
