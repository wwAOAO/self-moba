...
type EquipmentStats struct {
	...
	BaseHPRegenBonus   float64 `json:"baseHpRegenBonus,omitempty"`
	...
	PhysicalPenPercent float64 `json:"physicalPenPercent,omitempty"`
	MagicPenPercent    float64 `json:"magicPenPercent,omitempty"`
...
type EquipmentEffects struct {
	...
	LifeStealOverhealShieldMin        int     `json:"lifeStealOverhealShieldMin,omitempty"`
	LifeStealOverhealShieldMax        int     `json:"lifeStealOverhealShieldMax,omitempty"`
	TargetBonusHPDamageMaxRatio       float64 `json:"targetBonusHpDamageMaxRatio,omitempty"`
	TargetBonusHPDamageFullAt         float64 `json:"targetBonusHpDamageFullAt,omitempty"`
	SkillDamageLowHealthSlow          float64 `json:"skillDamageLowHealthSlow,omitempty"`
	SkillDamageLowHealthSlowThreshold float64 `json:"skillDamageLowHealthSlowThreshold,omitempty"`
	...
	ThornsDamageFlat                  float64 `json:"thornsDamageFlat,omitempty"`
	ThornsBonusArmorRatio             float64 `json:"thornsBonusArmorRatio,omitempty"`
	ThornsGrievousWounds              float64 `json:"thornsGrievousWounds,omitempty"`
	ThornsGrievousWoundsSeconds       float64 `json:"thornsGrievousWoundsSeconds,omitempty"`
	EquipmentHPMultiplier             float64 `json:"equipmentHpMultiplier,omitempty"`
	WarmogRequiredBonusHP             float64 `json:"warmogRequiredBonusHp,omitempty"`
	WarmogOutOfCombatSeconds          float64 `json:"warmogOutOfCombatSeconds,omitempty"`
	WarmogMinionOutOfCombatSeconds    float64 `json:"warmogMinionOutOfCombatSeconds,omitempty"`
	WarmogHealMaxHPRatio              float64 `json:"warmogHealMaxHpRatio,omitempty"`
	WarmogTickSeconds                 float64 `json:"warmogTickSeconds,omitempty"`
	EndlessDespairRadius              float64 `json:"endlessDespairRadius,omitempty"`
	EndlessDespairTickSeconds         float64 `json:"endlessDespairTickSeconds,omitempty"`
	EndlessDespairBonusHPRatio        float64 `json:"endlessDespairBonusHpRatio,omitempty"`
	EndlessDespairHealDamageRatio     float64 `json:"endlessDespairHealDamageRatio,omitempty"`
	...
	HeroDamageBonusMagicDamage        float64 `json:"heroDamageBonusMagicDamage,omitempty"`
	HeroDamageBonusCooldownSeconds    float64 `json:"heroDamageBonusCooldownSeconds,omitempty"`
	LowHealthMagicTrueDamageBonus     float64 `json:"lowHealthMagicTrueDamageBonus,omitempty"`
	LowHealthDotPetDamageBonus        float64 `json:"lowHealthDotPetDamageBonus,omitempty"`
	LowHealthDamageThreshold          float64 `json:"lowHealthDamageThreshold,omitempty"`
	EchoDamage                        float64 `json:"echoDamage,omitempty"`
	EchoAPRatio                       float64 `json:"echoApRatio,omitempty"`
	EchoCooldownSeconds               float64 `json:"echoCooldownSeconds,omitempty"`
	EchoBounceRadius                  float64 `json:"echoBounceRadius,omitempty"`
	EchoCastCharge                    float64 `json:"echoCastCharge,omitempty"`
	EchoMoveDistancePerCharge         float64 `json:"echoMoveDistancePerCharge,omitempty"`
	EchoChargePerStack                float64 `json:"echoChargePerStack,omitempty"`
	EchoMaxStacks                     float64 `json:"echoMaxStacks,omitempty"`
}
...
func NewEquipmentStore(items []EquipmentConfig) (*EquipmentStore, error) {
	...
	for _, item := range items {
		...
		if item.Stats.HP < 0 || item.Stats.MP < 0 || item.Stats.HPRegen5 < 0 || item.Stats.MPRegen5 < 0 ||
			item.Stats.BaseHPRegenBonus < 0 || item.Stats.BaseMPRegenBonus < 0 ||
			item.Stats.Attack < 0 || item.Stats.AbilityPower < 0 || item.Stats.AbilityHaste < 0 ||
			item.Stats.PhysicalDefense < 0 || item.Stats.MagicDefense < 0 ||
			item.Stats.PhysicalPenPercent < 0 || item.Stats.MagicPenPercent < 0 || item.Stats.MagicPenFlat < 0 ||
		...
		if item.Effects.LevelUpRestoreHPRatio < 0 || item.Effects.LevelUpRestoreMPRatio < 0 ||
			...
			item.Effects.LifeStealOverhealShieldMin < 0 || item.Effects.LifeStealOverhealShieldMax < 0 ||
			item.Effects.TargetBonusHPDamageMaxRatio < 0 || item.Effects.TargetBonusHPDamageFullAt < 0 ||
			...
			item.Effects.ThornsGrievousWounds < 0 || item.Effects.ThornsGrievousWoundsSeconds < 0 ||
			item.Effects.EquipmentHPMultiplier < 0 || item.Effects.WarmogRequiredBonusHP < 0 ||
			item.Effects.WarmogOutOfCombatSeconds < 0 || item.Effects.WarmogMinionOutOfCombatSeconds < 0 ||
			item.Effects.WarmogHealMaxHPRatio < 0 || item.Effects.WarmogTickSeconds < 0 ||
			item.Effects.EndlessDespairRadius < 0 || item.Effects.EndlessDespairTickSeconds < 0 ||
			item.Effects.EndlessDespairBonusHPRatio < 0 || item.Effects.EndlessDespairHealDamageRatio < 0 ||
			...
			item.Effects.HeroDamageBonusMagicDamage < 0 || item.Effects.HeroDamageBonusCooldownSeconds < 0 ||
			item.Effects.LowHealthMagicTrueDamageBonus < 0 || item.Effects.LowHealthDotPetDamageBonus < 0 ||
			item.Effects.LowHealthDamageThreshold < 0 || item.Effects.EchoDamage < 0 ||
			item.Effects.EchoAPRatio < 0 || item.Effects.EchoCooldownSeconds < 0 ||
			item.Effects.EchoBounceRadius < 0 || item.Effects.EchoCastCharge < 0 ||
			item.Effects.EchoMoveDistancePerCharge < 0 || item.Effects.EchoChargePerStack < 0 ||
			item.Effects.EchoMaxStacks < 0 {
